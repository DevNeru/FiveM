...
Config.ShowBlips = false -- Blips op de map - Ja = True
Config.OnlyBank = false -- Alleen pinnen bij bank - Ja = True
...
Config.ATM = { -- Pinautomaten
    ...
    {id = 277, x = 315.09, y = -593.70, z = 43.28}
}
